<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="PalindromeCheckPage.aspx.vb" Inherits="PalindromeCheck.PalindromeCheckPage" %>
...
<div class="row">    
        <div class="col-md-8">
            <div class="form-group">
                ...
                <input type="number" min="1" runat="server" class="form-control" id="valueInput" ClientIdMode="Static" aria-describedby="amountHelp" placeholder="Enter a positive number:">
